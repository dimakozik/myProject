...
public class AddGoalPopUp {

	public AddGoalPopUp(WebDriver driver) {
	...
	@FindBy(css = "#header-controller-add-goal-header-create-objective-quarters-select-input")
	public WebElement quarterDropDawnInput;
